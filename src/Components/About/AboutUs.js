          ...
          <div class="col-lg-12 col-md-12 text-left">
            <div class="about-story-con">
              ...
              <p>
                ...
                </Link>{" "} students make their future very
                bright and a bright future of students can make a developed
                country.
              </p>
            
              <p>
                Today, we are recognized under the top Scholarships Information Provider
                Organization by renowned researching organizations and firms. We
                owe the entire credit to our keen team of designers, developers
                and strategists; who never let things go! In a single word,{" "}
                <Link style={{ textDecoration: "none" }} to="/">
                  <a class="internal-links" href="#">
                    Scholars
                  </a>
...
<p>
As students, we have always experienced the joy of success in getting scholarships. When any student gets scholarship information from our platform and gets succeeds in it, it's a very delighted feeling for us. We believe in student benefit hence we can't take any personal information.
</p>
...
<h5>Students Benefited
</h5>
</div>
</div>
<div class="col-md-12 col-sm-12 right">
<div class="row">
<div class="col-md-6 col-sm-6" style={{borderTop: "1px solid black", borderRight: "1px solid black", padding: "30px"}}>
...
<h5>Organization Connected
</h5>
</div>
</div>
<div class="col-md-6 col-sm-6" style={{borderTop: "1px solid black", padding: "30px"}}>
<div class="we-are-box">
<div class="counter-box">
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 text-center">
           ...
           {" "}
                ...
                </Link>{" "}'s mission is to organize scholarship information in a good manner and help to get scholarships to every needy student.
              </p>
...
<div class="container pt-100">
        <div class="row">
          <div class="col-lg-12 col-md-12 text-center">
           ...
           {" "}
                ...
                </Link>{" "}'s Goal is to help 100000+ student to get scholarships and to connect every organizations to expand it world wide.
              </p>
      ...
      <section class="food-client-video  home-food-client-video pb-5" style={{backgroundColor: "rgb(220 236 251 / 71%)"}}>
<div class="container">
<div class="row">
